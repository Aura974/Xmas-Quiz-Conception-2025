...
Le développement du projet **Quiz de Noël** suivra une approche **agile simplifiée**, adaptée à une équipe individuelle et à un périmètre limité dans le temps (livraison d’un MVP en un mois).
...
* Le **CdCF** et le **TSD** servent de documents de référence vivants, pouvant être ajustés à chaque itération si nécessaire.
...
* Un **backlog** initial regroupera les fonctionnalités MVP, tandis qu’un backlog secondaire (projections futures) contiendra les ajouts non essentiels.
...
* La validation finale consistera à tester :

  * le flux complet *Accueil → Quiz → Score → Classement → Rejouer*,
  * la cohérence des scores et des temps,
  * la conformité avec les critères d’accessibilité et de fluidité.
