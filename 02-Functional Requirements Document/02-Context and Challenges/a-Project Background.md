...
Le projet **Quiz de Noël** s’inscrit dans le cadre des activités internes de la **Nordev**, dans une optique de **dynamisation et de convivialité** en période de fêtes de fin d’année.

Il s’agit d’une **application web privée**, développée pour un usage exclusivement **interne au sein de la Nordev**, destinée à proposer une expérience ludique et festive aux enfants des collaborateurs ou aux participants d’événements internes.
